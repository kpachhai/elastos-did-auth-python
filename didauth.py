...
def register_with_elastos():
    public_key = "02b8d47891ea51dd78ed97d49697fbb426bcaa6cb94f25e29714b873fb624c80d1"
    did = "iTHeDCTWrTFiV9HwrFMHy8ede59Aq62TrD"
    app_id = "67b054ec2392ef0723fb5a1bee0b730eacb1d371fb0349ed95023d6a8dbdb9aa27c3eff7f28fb3f0a5b62fb48c16e0cac87d62f6f2585066db57e56272b943b7"
    app_name = "LaravelKPTest"

    random = randint(10000000000,999999999999)
    session['elaState'] = random

    url_params = {
        'CallbackUrl': 'http://192.168.1.23:5000/api/did/callback',
